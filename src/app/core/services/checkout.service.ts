...
import {
  ...
  ConfiguracionIzipay,
  TestConfiguracionIzipay,
  SolicitudSimularPagoIzipay,
  RespuestaSimularPagoIzipay,
  ItemCheckout,
...
export class CheckoutService {
    ...
    return this.http
      ...
      .pipe(
        ...
        tap((resultado) => {
          ...
          // El componente manejará el flujo después de Izipay
          this.actualizarEstado({
            en_proceso: false,
          });
        }),
  ...
  /**
   * Probar configuración de credenciales de Izipay
   */
  probarConfiguracionIzipay(): Observable<TestConfiguracionIzipay> {
    return this.http
      .get<ApiResponse<TestConfiguracionIzipay>>(`${this.apiUrl}/izipay/test`)
      .pipe(
        map((response) => this.extraerDatos(response)),
        catchError(this.manejarError)
      );
   ...
   */
  simularPagoExitosoIzipay(
    solicitud: SolicitudSimularPagoIzipay
  ): Observable<RespuestaSimularPagoIzipay> {
    return this.http
      .post<ApiResponse<RespuestaSimularPagoIzipay>>(
        `${this.apiUrl}/izipay/simular-pago-exitoso`,
        solicitud
      )
      .pipe(
        map((response) => this.extraerDatos(response)),
